...
const Footer = () => {
  ...
  <div>
    ...
    <a className="link link-hover flex gap-3 text-green-700"><FaPhone /> 01740100570</a> 
    <a className="link link-hover flex gap-3 text-green-700"><FaMailBulk />niloyabidur@gmail.com</a> 
  </div>
</footer> 
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p>Forto Industries Ltd. <br/>Providing reliable tech {(new Date().getFullYear())}</p>
  </div> 
